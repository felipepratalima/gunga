...
QIIME_PROFILE_LOCATION <- system.file("extdata", "../../data-raw/qiime/open_reference_otus/taxa_summary/otu_table_mc2_w_tax_L6.txt", package = "gunga")
QIIME_CLASSIFICATIONS_LOCATION <- system.file("extdata", "../../data-raw/qiime/open_reference_otus/uclust_assigned_taxonomy/rep_set_tax_assignments.txt", package = "gunga")
